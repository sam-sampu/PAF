...
public class Products {
    ...
    String AddProducts(String ID, String inv_no, String pro_code, String pro_des,String price,String qty,String subtot)
    {
        String output;
        try
        {
    ...
    String updateProducts(String ID, String inv_no, String pro_code, String pro_des, String price, String qty, String subtot)
    {
        String output;
        try
        {
    ...
    public String deleteProducts(String AppointmentID)
    {
        String output;
        try
        {
