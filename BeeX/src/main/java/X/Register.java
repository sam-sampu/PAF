...
public class Register {
    ...
    String AddRegister(String ID, String inv_no, String pro_code, String pro_des,String price,String qty,String subtot)
    {
        String output;
        try
        {
    ...
    String updateRegister(String ID, String inv_no, String pro_code, String pro_des, String price, String qty, String subtot)
    {
        String output;
        try
        {
    ...
    String deleteRegister(String AppointmentID)
    {
        String output;
        try
        {
